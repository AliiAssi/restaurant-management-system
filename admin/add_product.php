...
<body>
    ...
    <div class="innercard p-2">
        ...
        } else if(isset($_SESSION["added"]) && $_SESSION["added"]) 
        {
        ?>
            <div class="popup" id="alertPopup">
            <div class="popup-content">
                <span class="close-btn" onclick="closePopup()">&times;</span>
                <p>product added succsefully !</p>
            </div>
            </div>
        <?php 
            ...
            <div class="row">
                <div class="col-md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        <img class="rounded-circle mt-5" width="150px" src="images/adding.png">
                        <span class="font-weight-bold">Yummy Menu</span><span class="text-black-50"></span><span>
                        </span>
                    </div>
                </div>
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <form action="control/add_product.php" method="post" name="ff" enctype="multipart/form-data">
                            <div class="row mt-2">
                                <div class="col-md-6"><label class="labels">name</label><input type="text"
                                        class="form-control" placeholder="enter the name" name="name"></div>
                            </div>
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12"><label class="labels">category</label>
                                    <div class="select-wrapper">
                                        <select class="custom-select" name="category" onchange="showSelectedOption()">
                                ...
                                <div class="o">
                                        <select id="his_id" class="custom-selectt" onchange="drinks()" name="drink_category">
                                            <option value="" disabled selected>Select an option</option>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="file-input-wrapper">
                                        <input type="file" name="image" accept="image/*" id="fileInput" class="input-file" required>
                                        <label for="fileInput" class="custom-label">Choose an image</label>
                                    </div>
                                    <div class="mt-5 text-center">
                                        <input type="submit" name="save" class="btn btn-primary profile-button" value="Save" />
                                    </div>
                        </form>
                    </div>
                </div>
