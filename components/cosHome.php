...
<body>
    ...
    <section class="showcase-area" id="showcase">
        <div class="showcase-container">
            ...
            <a href="cosMenu.php" class="btn btn-primary">Menu</a>
        </div>
    </section>
    <section id="about">
        <div class="about-wrapper container">
            ...
            <p class="small">About Us</p>
                ...
                <p>
                    At YUMY, we're passionate about providing you with delicious and nutritious food options. For over a decade, we have been dedicated to crafting meals that not only satisfy your taste buds but also contribute to your well-being.
                </p>
            </div>
            <div class="about-img">
