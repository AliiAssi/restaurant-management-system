<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="cosHome.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="cosMenu.php?menu=menu">menu</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="orders_summary.php">orders</a>
          <a class="dropdown-item" href="cosReservation.php">reservation</a>
          <a class="dropdown-item" href="cosChat.php">Yumy live chat</a>
        </div>
      </li>
    </ul>
...
<script>
  function heart()
  {
    window.location.href = "cosMenu.php?favourite=favorite";
  }
  function reservation()
  {
    window.location.href = "cosReservation.php";
  }
  function chat()
  {
